...
export const Icons: Record<string, (p: IP) => React.JSX.Element> = {
  ...
  edit: (p) => (<Icon {...p} size={p.size || 15}><path d="M12 20h9M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5Z" /></Icon>),
  trash: (p) => (<Icon {...p} size={p.size || 15}><path d="M4 7h16M9 7V4h6v3M6 7l1 13h10l1-13M10 11v6M14 11v6" /></Icon>),
};
